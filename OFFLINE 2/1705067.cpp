...
public:
    ...
    void getOrderedPoint(double ys, int triCount){
        //cout<<"---------------------------------------------------------Ordered Point------------------------------"<<endl;
        int i,countUp, countDown, posUp, posDown;
        countUp = 0;
        countDown = 0;
        Triangle tempTri = this->triArr[triCount];

        for( i = 0; i < 3; i++){
            if( tempTri.Points[i].y <= ys  ){
                countDown++;
                posDown = i;
            }
            else{
        ...
        if(countUp == 1){
            this->orderedPoints[0] = tempTri.Points[posUp];
            if(posUp == 0){
                this->orderedPoints[1] = tempTri.Points[1];
                this->orderedPoints[2] = tempTri.Points[2];
            }
            else if(posUp == 1){
                this->orderedPoints[1] = tempTri.Points[0];
                this->orderedPoints[2] = tempTri.Points[2];
            }
            else if(posUp == 2){
                this->orderedPoints[1] = tempTri.Points[0];
                this->orderedPoints[2] = tempTri.Points[1];
            }

        }
        else{
            this->orderedPoints[0] = tempTri.Points[posDown];
            if(posDown == 0){
                this->orderedPoints[1] = tempTri.Points[1];
                this->orderedPoints[2] = tempTri.Points[2];
            }
...
//                zc = calcPointVal(ys, tempTri.Points[2].y, tempTri.Points[1].y, tempTri.Points[2].z, tempTri.Points[1].z );
                ...
                getOrderedPoint(ys,k);

                xa = calcPointVal(ys, this->orderedPoints[1].y, this->orderedPoints[0].y, this->orderedPoints[1].x, this->orderedPoints[0].x );
                xb = calcPointVal(ys, this->orderedPoints[2].y, this->orderedPoints[0].y, this->orderedPoints[2].x, this->orderedPoints[0].x );
                xc = calcPointVal(ys, this->orderedPoints[2].y, this->orderedPoints[1].y, this->orderedPoints[2].x, this->orderedPoints[1].x );

                za = calcPointVal(ys, this->orderedPoints[1].y, this->orderedPoints[0].y, this->orderedPoints[1].z, this->orderedPoints[0].z );
                zb = calcPointVal(ys, this->orderedPoints[2].y, this->orderedPoints[0].y, this->orderedPoints[2].z, this->orderedPoints[0].z );
                zc = calcPointVal(ys, this->orderedPoints[2].y, this->orderedPoints[1].y, this->orderedPoints[2].z, this->orderedPoints[1].z );
